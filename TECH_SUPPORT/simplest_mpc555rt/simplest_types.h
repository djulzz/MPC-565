...
#ifndef RTW_HEADER_simplest_types_h_
#define RTW_HEADER_simplest_types_h_

/* Forward declaration for rtModel */
typedef struct RT_MODEL_simplest RT_MODEL_simplest;

#endif                                 /* RTW_HEADER_simplest_types_h_ */
