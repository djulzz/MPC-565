...
#include "Simplest30.h"
#include "Simplest30_private.h"

/* Block states (auto storage) */
D_Work_Simplest30 Simplest30_DWork;

/* Real-time model */
RT_MODEL_Simplest30 Simplest30_M_;
RT_MODEL_Simplest30 *Simplest30_M = &Simplest30_M_;

/* Model step function */
void Simplest30_step(void)
{
...

  {
    ...
    for (i = 0; i < 17; i++) {
      rtb_DataStoreRead[i] = Simplest30_DWork.buffer_transmit_com3[i];
    }
...
void Simplest30_initialize(boolean_T firstTime)
{
  (void)firstTime;

  {
    ...
    for (i = 0; i < 17; i++) {
      Simplest30_DWork.buffer_transmit_com3[i] =
        Simplest30_ConstP.DataStoreMemory4_Ini[i];
    }
  }
}
