...
#ifndef RTW_HEADER_minimalist_rep_private_h_
#define RTW_HEADER_minimalist_rep_private_h_
#include "rtwtypes.h"
...
#endif                                 /* RTW_HEADER_minimalist_rep_private_h_ */
