/*
 * File: Simplest_With_For_Iterator3.c
 *
...
#include "Simplest_With_For_Iterator3.h"
#include "Simplest_With_For_Iterator3_private.h"

/* Block states (auto storage) */
D_Work_Simplest_With_For_Iterat Simplest_With_For_Iterato_DWork;

/* Real-time model */
RT_MODEL_Simplest_With_For_Iter Simplest_With_For_Iterator3_M_;
RT_MODEL_Simplest_With_For_Iter *Simplest_With_For_Iterator3_M =
  &Simplest_With_For_Iterator3_M_;

/* Model step function */
void Simplest_With_For_Iterator3_step(void)
{
...

  {
    ...
    /* Outputs for atomic SubSystem: '<Root>/Simplest_With_For_Iterator3' */
    ...
    /* end of Outputs for SubSystem: '<Root>/Simplest_With_For_Iterator3' */
  }
}

/* Model initialize function */
void Simplest_With_For_Iterator3_initialize(boolean_T firstTime)
{
  (void)firstTime;

  {
    ...
    /* Start for atomic SubSystem: '<Root>/Simplest_With_For_Iterator3' */
    ...
    /* end of Start for SubSystem: '<Root>/Simplest_With_For_Iterator3' */
  }
}
