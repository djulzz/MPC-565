/*
 * File: Simplest_With_For_Iterator.c
 *
...
#include "Simplest_With_For_Iterator.h"
#include "Simplest_With_For_Iterator_private.h"

/* Block states (auto storage) */
D_Work_Simplest_With_For_Iterat Simplest_With_For_Iterato_DWork;

/* Real-time model */
RT_MODEL_Simplest_With_For_Iter Simplest_With_For_Iterator_M_;
RT_MODEL_Simplest_With_For_Iter *Simplest_With_For_Iterator_M =
  &Simplest_With_For_Iterator_M_;

/* Model step function */
void Simplest_With_For_Iterator_step(void)
{
...

  {
    ...
    for (i = 0; i < 17; i++) {
      ...
      /* S-Function (qsmcm_sci_tx): '<S2>/Serial Transmit' */
...
void Simplest_With_For_Iterator_initialize(boolean_T firstTime)
{
  (void)firstTime;

  {
    ...
    for (i = 0; i < 17; i++) {
      Simplest_With_For_Iterato_DWork.buffer_transmit_com3[i] =
        Simplest_With_For_Iterat_ConstP._DataStoreBlk_1_Init[i];
    }
  }
}
