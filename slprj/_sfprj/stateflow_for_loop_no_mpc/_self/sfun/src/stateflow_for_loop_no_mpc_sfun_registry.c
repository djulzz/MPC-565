...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_stateflow_for_loop_no_mpc_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_stateflow_for_loop_no_mpc_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_stateflow_for_loop_no_mpc_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_stateflow_for_loop_no_mpc_autoinheritance_info(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_stateflow_for_loop_no_mpc_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "stateflow_for_loop_no_mpc") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_stateflow_for_loop_no_mpc_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
extern unsigned int sf_stateflow_for_loop_no_mpc_method_dispatcher(SimStruct *S,
...
{
  if (!strcmp(machineName,"stateflow_for_loop_no_mpc")) {
    return(sf_stateflow_for_loop_no_mpc_method_dispatcher(simstructPtr,
...
extern void stateflow_for_loop_no_mpc_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    stateflow_for_loop_no_mpc_terminator();
    sf_debug_terminate();
  }
...
extern void stateflow_for_loop_no_mpc_initializer(void);
extern void stateflow_for_loop_no_mpc_register_exported_symbols(SimStruct* S);
extern void stateflow_for_loop_no_mpc_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  stateflow_for_loop_no_mpc_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      stateflow_for_loop_no_mpc_debug_initialize();
    }

    stateflow_for_loop_no_mpc_initializer();
  }
