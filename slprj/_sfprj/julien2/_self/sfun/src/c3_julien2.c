...
static SFc3_julien2InstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c3_julien2(void);
static void initialize_params_c3_julien2(void);
static void enable_c3_julien2(void);
static void disable_c3_julien2(void);
static void c3_update_debugger_state_c3_julien2(void);
static const mxArray *get_sim_state_c3_julien2(void);
static void set_sim_state_c3_julien2(const mxArray *c3_st);
static void finalize_c3_julien2(void);
static void sf_c3_julien2(void);
...
static void initialize_c3_julien2(void)
{
  ...
  chartInstance.c3_is_active_c3_julien2 = 0U;
}
...
static const mxArray *get_sim_state_c3_julien2(void)
{
  ...
  c3_b_u = chartInstance.c3_is_active_c3_julien2;
  c3_c_y = NULL;
...
static void set_sim_state_c3_julien2(const mxArray *c3_st)
{
  ...
  *c3_c_byte = c3_y;
  ...
  sf_mex_import("is_active_c3_julien2", sf_mex_dup(c3_b_byte), &c3_u1, 1, 3, 0U,
                0, 0U, 0);
  c3_b_y = c3_u1;
  sf_mex_destroy(&c3_b_byte);
  chartInstance.c3_is_active_c3_julien2 = c3_b_y;
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_julien2();
...
const mxArray *sf_c3_julien2_get_eml_resolved_functions_info(void)
{
...
/* SFunction Glue Code */
void sf_c3_julien2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_julien2_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c3_julien2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[8],T\"byte\",},{M[8],M[0],T\"is_active_c3_julien2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_julien2_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c3_julien2(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c3_julien2();
  initialize_c3_julien2();
}

static void sf_opaque_enable_c3_julien2(void *chartInstanceVar)
{
  enable_c3_julien2();
}

static void sf_opaque_disable_c3_julien2(void *chartInstanceVar)
{
  disable_c3_julien2();
}

static void sf_opaque_gateway_c3_julien2(void *chartInstanceVar)
{
  sf_c3_julien2();
}

static mxArray* sf_opaque_get_sim_state_c3_julien2(void *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c3_julien2();
  return st;
}

static void sf_opaque_set_sim_state_c3_julien2(void *chartInstanceVar, const
  mxArray *st)
{
  set_sim_state_c3_julien2(sf_mex_dup(st));
}

static void sf_opaque_terminate_c3_julien2(void *chartInstanceVar)
{
...
static void mdlProcessParameters_c3_julien2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_julien2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("julien2","julien2",3);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("julien2","julien2",3,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("julien2","julien2",3,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"julien2","julien2",3,1);
      sf_mark_chart_reusable_outputs(S,"julien2","julien2",3,1);
    }

    sf_set_rtw_dwork_info(S,"julien2","julien2",3);
...
static void mdlRTW_c3_julien2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "julien2", "julien2",3);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c3_julien2(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c3_julien2;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c3_julien2;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c3_julien2;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c3_julien2;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c3_julien2;
  chartInstance.chartInfo.getSimState = sf_opaque_get_sim_state_c3_julien2;
  chartInstance.chartInfo.setSimState = sf_opaque_set_sim_state_c3_julien2;
  chartInstance.chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_julien2;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c3_julien2;
  chartInstance.chartInfo.mdlStart = mdlStart_c3_julien2;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_julien2;
...
void c3_julien2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_julien2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_julien2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_julien2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_julien2_method_dispatcher.\n"
