...
static SFc1_julien2InstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c1_julien2(void);
static void initialize_params_c1_julien2(void);
static void enable_c1_julien2(void);
static void disable_c1_julien2(void);
static void c1_update_debugger_state_c1_julien2(void);
static const mxArray *get_sim_state_c1_julien2(void);
static void set_sim_state_c1_julien2(const mxArray *c1_st);
static void finalize_c1_julien2(void);
static void sf_c1_julien2(void);
...
static void initialize_c1_julien2(void)
{
  ...
  chartInstance.c1_is_active_c1_julien2 = 0U;
}
...
static const mxArray *get_sim_state_c1_julien2(void)
{
  ...
  c1_u = chartInstance.c1_is_active_c1_julien2;
  c1_b_y = NULL;
...
{
  const mxArray *c1_u;
  const mxArray *c1_b_is_active_c1_julien2;
  uint8_T c1_u0;
  uint8_T c1_y;
  chartInstance.c1_doneDoubleBufferReInit = true;
  c1_u = sf_mex_dup(c1_st);
  c1_b_is_active_c1_julien2 = sf_mex_dup(sf_mex_getcell(c1_u, 0));
  sf_mex_import("is_active_c1_julien2", sf_mex_dup(c1_b_is_active_c1_julien2),
                &c1_u0, 1, 3, 0U, 0, 0U, 0);
  c1_y = c1_u0;
  sf_mex_destroy(&c1_b_is_active_c1_julien2);
  chartInstance.c1_is_active_c1_julien2 = c1_y;
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_julien2();
...
const mxArray *sf_c1_julien2_get_eml_resolved_functions_info(void)
{
...
/* SFunction Glue Code */
void sf_c1_julien2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_julien2_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c1_julien2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c1_julien2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 1, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_julien2_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_julien2(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c1_julien2();
  initialize_c1_julien2();
}

static void sf_opaque_enable_c1_julien2(void *chartInstanceVar)
{
  enable_c1_julien2();
}

static void sf_opaque_disable_c1_julien2(void *chartInstanceVar)
{
  disable_c1_julien2();
}

static void sf_opaque_gateway_c1_julien2(void *chartInstanceVar)
{
  sf_c1_julien2();
}

static mxArray* sf_opaque_get_sim_state_c1_julien2(void *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c1_julien2();
  return st;
}

static void sf_opaque_set_sim_state_c1_julien2(void *chartInstanceVar, const
  mxArray *st)
{
  set_sim_state_c1_julien2(sf_mex_dup(st));
}

static void sf_opaque_terminate_c1_julien2(void *chartInstanceVar)
{
...
static void mdlProcessParameters_c1_julien2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_julien2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("julien2","julien2",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("julien2","julien2",1,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("julien2","julien2",1,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"julien2","julien2",1,3);
    }

    sf_set_rtw_dwork_info(S,"julien2","julien2",1);
...
static void mdlRTW_c1_julien2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "julien2", "julien2",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_julien2(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c1_julien2;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c1_julien2;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c1_julien2;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c1_julien2;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c1_julien2;
  chartInstance.chartInfo.getSimState = sf_opaque_get_sim_state_c1_julien2;
  chartInstance.chartInfo.setSimState = sf_opaque_set_sim_state_c1_julien2;
  chartInstance.chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_julien2;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c1_julien2;
  chartInstance.chartInfo.mdlStart = mdlStart_c1_julien2;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_julien2;
...
void c1_julien2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_julien2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_julien2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_julien2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_julien2_method_dispatcher.\n"
