...
#include "julien0_sfun_debug_macros.h"
...
static SFc2_julien0InstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_julien0(void);
static void initialize_params_c2_julien0(void);
static void enable_c2_julien0(void);
static void disable_c2_julien0(void);
static void c2_update_debugger_state_c2_julien0(void);
static const mxArray *get_sim_state_c2_julien0(void);
static void set_sim_state_c2_julien0(const mxArray *c2_st);
static void c2_set_sim_state_side_effects_c2_julien0(void);
static void finalize_c2_julien0(void);
static void sf_c2_julien0(void);
...
static void initialize_c2_julien0(void)
{
  ...
  chartInstance.c2_is_active_c2_julien0 = 0U;
  chartInstance.c2_is_c2_julien0 = 0U;
...
static void c2_update_debugger_state_c2_julien0(void)
{
  ...
  if ((int16_T)chartInstance.c2_is_active_c2_julien0 == 1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG,1);
  }

  if ((int16_T)chartInstance.c2_is_c2_julien0 == c2_IN_End) {
...
static const mxArray *get_sim_state_c2_julien0(void)
{
  ...
  c2_h_u = chartInstance.c2_is_active_c2_julien0;
  c2_i_y = NULL;
  sf_mex_assign(&c2_i_y, sf_mex_create("y", &c2_h_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c2_y, 7, c2_i_y);
  c2_i_u = chartInstance.c2_is_c2_julien0;
  c2_j_y = NULL;
...
static void set_sim_state_c2_julien0(const mxArray *c2_st)
{
  ...
  *c2_call_write_to_nav = c2_g_y;
  ...
  c2_update_debugger_state_c2_julien0();
...
static void sf_c2_julien0(void)
{
  ...
  c2_call_write_com3_buffer_third_byte = (uint8_T *)ssGetOutputPortSignal
    (chartInstance.S, 7);
  c2_set_sim_state_side_effects_c2_julien0();
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  ...
  if ((int16_T)chartInstance.c2_is_active_c2_julien0 == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG,1);
    chartInstance.c2_is_active_c2_julien0 = 1U;
    ...
    chartInstance.c2_tp_End = 0U;
    chartInstance.c2_is_c2_julien0 = (uint8_T)c2_IN_NO_ACTIVE_CHILD;
    _SFD_CS_CALL(STATE_INACTIVE_TAG,0);
  ...
  sf_debug_check_for_state_inconsistency(_julien0MachineNumber_,
...
static void c2_enter_atomic_End(void)
{
  ...
  c2_call_write_com3_buffer_third_byte = (uint8_T *)ssGetOutputPortSignal
    (chartInstance.S, 7);
  chartInstance.c2_is_c2_julien0 = (uint8_T)c2_IN_End;
  _SFD_CS_CALL(STATE_ACTIVE_TAG,0);
  chartInstance.c2_tp_End = 1U;
...
const mxArray *sf_c2_julien0_get_eml_resolved_functions_info(void)
{
...
void sf_c2_julien0_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_julien0_get_autoinheritance_info(void)
{
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart(_julien0MachineNumber_,
          2,
          1,
          2,
          8,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_julien0MachineNumber_,
            chartInstance.chartNumber);
          sf_debug_set_chart_disable_implicit_casting(_julien0MachineNumber_,
            chartInstance.chartNumber,1);
          sf_debug_set_chart_event_thresholds(_julien0MachineNumber_,
            chartInstance.chartNumber,
            0,
            0,
            0);
      ...
      sf_debug_reset_current_state_configuration(_julien0MachineNumber_,
        chartInstance.chartNumber,chartInstance.instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c2_julien0(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_julien0();
  initialize_c2_julien0();
}

static void sf_opaque_enable_c2_julien0(void *chartInstanceVar)
{
  enable_c2_julien0();
}

static void sf_opaque_disable_c2_julien0(void *chartInstanceVar)
{
  disable_c2_julien0();
}

static void sf_opaque_gateway_c2_julien0(void *chartInstanceVar)
{
  sf_c2_julien0();
}

static mxArray* sf_opaque_get_sim_state_c2_julien0(void *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c2_julien0();
  return st;
}

static void sf_opaque_set_sim_state_c2_julien0(void *chartInstanceVar, const
  mxArray *st)
{
  set_sim_state_c2_julien0(sf_mex_dup(st));
}

static void sf_opaque_terminate_c2_julien0(void *chartInstanceVar)
{
...
static void mdlProcessParameters_c2_julien0(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_julien0(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("julien0","julien0",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("julien0","julien0",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("julien0","julien0",2,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      sf_mark_chart_reusable_outputs(S,"julien0","julien0",2,7);
    }

    sf_set_rtw_dwork_info(S,"julien0","julien0",2);
...
static void mdlRTW_c2_julien0(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "julien0", "julien0",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Stateflow");
  }
}

static void mdlStart_c2_julien0(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 0;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c2_julien0;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c2_julien0;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c2_julien0;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c2_julien0;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c2_julien0;
  chartInstance.chartInfo.getSimState = sf_opaque_get_sim_state_c2_julien0;
  chartInstance.chartInfo.setSimState = sf_opaque_set_sim_state_c2_julien0;
  chartInstance.chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_julien0;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_julien0;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_julien0;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_julien0;
...
void c2_julien0_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_julien0(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_julien0(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_julien0(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_julien0_method_dispatcher.\n"
