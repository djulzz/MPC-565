...
static SFc2_minimalist14InstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_minimalist14(void);
static void initialize_params_c2_minimalist14(void);
static void enable_c2_minimalist14(void);
static void disable_c2_minimalist14(void);
static void c2_update_debugger_state_c2_minimalist14(void);
static const mxArray *get_sim_state_c2_minimalist14(void);
static void set_sim_state_c2_minimalist14(const mxArray *c2_st);
static void c2_set_sim_state_side_effects_c2_minimalist14(void);
static void finalize_c2_minimalist14(void);
static void sf_c2_minimalist14(void);
...
static void initialize_c2_minimalist14(void)
{
  ...
  chartInstance.c2_is_active_c2_minimalist14 = 0U;
  chartInstance.c2_is_c2_minimalist14 = 0U;
...
static void c2_update_debugger_state_c2_minimalist14(void)
{
  ...
  if ((int16_T)chartInstance.c2_is_active_c2_minimalist14 == 1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG,1);
  }

  if ((int16_T)chartInstance.c2_is_c2_minimalist14 == c2_IN_STEP) {
...
static const mxArray *get_sim_state_c2_minimalist14(void)
{
  ...
  c2_b_u = chartInstance.c2_is_active_c2_minimalist14;
  c2_c_y = NULL;
  sf_mex_assign(&c2_c_y, sf_mex_create("y", &c2_b_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c2_y, 1, c2_c_y);
  c2_c_u = chartInstance.c2_is_c2_minimalist14;
  c2_d_y = NULL;
...
static void set_sim_state_c2_minimalist14(const mxArray *c2_st)
{
  ...
  *c2_d_out = c2_y;
  ...
  sf_mex_import("is_active_c2_minimalist14", sf_mex_dup(c2_b_out), &c2_u1, 1, 3,
                0U, 0, 0U, 0);
  c2_b_y = c2_u1;
  sf_mex_destroy(&c2_b_out);
  chartInstance.c2_is_active_c2_minimalist14 = c2_b_y;
  c2_c_out = sf_mex_dup(sf_mex_getcell(c2_u, 2));
  sf_mex_import("is_c2_minimalist14", sf_mex_dup(c2_c_out), &c2_u2, 1, 3, 0U, 0,
                0U, 0);
  c2_c_y = c2_u2;
  sf_mex_destroy(&c2_c_out);
  chartInstance.c2_is_c2_minimalist14 = c2_c_y;
  ...
  c2_update_debugger_state_c2_minimalist14();
...
static void sf_c2_minimalist14(void)
{
  ...
  uint8_T *c2_out;
  c2_out = (uint8_T *)ssGetOutputPortSignal(chartInstance.S, 1);
  c2_set_sim_state_side_effects_c2_minimalist14();
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  ...
  if ((int16_T)chartInstance.c2_is_active_c2_minimalist14 == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG,1);
    chartInstance.c2_is_active_c2_minimalist14 = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG,1);
    chartInstance.c2_is_c2_minimalist14 = (uint8_T)c2_IN_STEP;
    _SFD_CS_CALL(STATE_ACTIVE_TAG,0);
    chartInstance.c2_tp_STEP = 1U;
...
const mxArray *sf_c2_minimalist14_get_eml_resolved_functions_info(void)
{
...
void sf_c2_minimalist14_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_minimalist14_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c2_minimalist14(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[2],T\"out\",},{M[8],M[0],T\"is_active_c2_minimalist14\",},{M[9],M[0],T\"is_c2_minimalist14\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_minimalist14_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_minimalist14(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_minimalist14();
  initialize_c2_minimalist14();
}

static void sf_opaque_enable_c2_minimalist14(void *chartInstanceVar)
{
  enable_c2_minimalist14();
}

static void sf_opaque_disable_c2_minimalist14(void *chartInstanceVar)
{
  disable_c2_minimalist14();
}

static void sf_opaque_gateway_c2_minimalist14(void *chartInstanceVar)
{
  sf_c2_minimalist14();
}

static mxArray* sf_opaque_get_sim_state_c2_minimalist14(void *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c2_minimalist14();
  return st;
}

static void sf_opaque_set_sim_state_c2_minimalist14(void *chartInstanceVar,
  const mxArray *st)
{
  set_sim_state_c2_minimalist14(sf_mex_dup(st));
}

static void sf_opaque_terminate_c2_minimalist14(void *chartInstanceVar)
{
  ...
  finalize_c2_minimalist14();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_minimalist14(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_minimalist14(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("minimalist14","minimalist14",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("minimalist14","minimalist14",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("minimalist14",
      "minimalist14",2,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      sf_mark_chart_reusable_outputs(S,"minimalist14","minimalist14",2,1);
    }

    sf_set_rtw_dwork_info(S,"minimalist14","minimalist14",2);
...
static void mdlRTW_c2_minimalist14(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "minimalist14", "minimalist14",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Stateflow");
  }
}

static void mdlStart_c2_minimalist14(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 0;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c2_minimalist14;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c2_minimalist14;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c2_minimalist14;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c2_minimalist14;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c2_minimalist14;
  chartInstance.chartInfo.getSimState = sf_opaque_get_sim_state_c2_minimalist14;
  chartInstance.chartInfo.setSimState = sf_opaque_set_sim_state_c2_minimalist14;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_minimalist14;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_minimalist14;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_minimalist14;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_minimalist14;
...
void c2_minimalist14_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_minimalist14(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_minimalist14(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_minimalist14(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_minimalist14_method_dispatcher.\n"
