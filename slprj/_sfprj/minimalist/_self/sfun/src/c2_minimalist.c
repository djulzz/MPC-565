...
static SFc2_minimalistInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_minimalist(void);
static void initialize_params_c2_minimalist(void);
static void enable_c2_minimalist(void);
static void disable_c2_minimalist(void);
static void c2_update_debugger_state_c2_minimalist(void);
static const mxArray *get_sim_state_c2_minimalist(void);
static void set_sim_state_c2_minimalist(const mxArray *c2_st);
static void c2_set_sim_state_side_effects_c2_minimalist(void);
static void finalize_c2_minimalist(void);
static void sf_c2_minimalist(void);
...
static void initialize_c2_minimalist(void)
{
  ...
  chartInstance.c2_is_active_c2_minimalist = 0U;
  chartInstance.c2_is_c2_minimalist = 0U;
...
static void c2_update_debugger_state_c2_minimalist(void)
{
  ...
  if ((int16_T)chartInstance.c2_is_active_c2_minimalist == 1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG,0);
  }

  if ((int16_T)chartInstance.c2_is_c2_minimalist == c2_IN_S01) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG,0);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG,0);
  }

  if ((int16_T)chartInstance.c2_is_c2_minimalist == c2_IN_S05) {
...
static const mxArray *get_sim_state_c2_minimalist(void)
{
  ...
  c2_f_u = chartInstance.c2_is_active_c2_minimalist;
  c2_g_y = NULL;
  sf_mex_assign(&c2_g_y, sf_mex_create("y", &c2_f_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c2_y, 5, c2_g_y);
  c2_g_u = chartInstance.c2_is_c2_minimalist;
  c2_h_y = NULL;
...
static void set_sim_state_c2_minimalist(const mxArray *c2_st)
{
  ...
  *c2_call_write_com3_buffer_third_byte = c2_e_y;
  ...
  sf_mex_import("is_active_c2_minimalist", sf_mex_dup
                (c2_f_call_request_nav_packet), &c2_u5, 1, 3, 0U, 0, 0U, 0);
  c2_f_y = c2_u5;
  sf_mex_destroy(&c2_f_call_request_nav_packet);
  chartInstance.c2_is_active_c2_minimalist = c2_f_y;
  c2_g_call_request_nav_packet = sf_mex_dup(sf_mex_getcell(c2_u, 6));
  sf_mex_import("is_c2_minimalist", sf_mex_dup(c2_g_call_request_nav_packet),
                &c2_u6, 1, 3, 0U, 0, 0U, 0);
  c2_g_y = c2_u6;
  sf_mex_destroy(&c2_g_call_request_nav_packet);
  chartInstance.c2_is_c2_minimalist = c2_g_y;
  ...
  c2_update_debugger_state_c2_minimalist();
...
static void sf_c2_minimalist(void)
{
  ...
  c2_call_write_com3_buffer_third_byte = (uint8_T *)ssGetOutputPortSignal
    (chartInstance.S, 5);
  c2_set_sim_state_side_effects_c2_minimalist();
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  ...
  if ((int16_T)chartInstance.c2_is_active_c2_minimalist == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG,0);
    chartInstance.c2_is_active_c2_minimalist = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG,0);
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG,0);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG,0);
    chartInstance.c2_is_c2_minimalist = (uint8_T)c2_IN_S01;
    _SFD_CS_CALL(STATE_ACTIVE_TAG,0);
    chartInstance.c2_tp_S01 = 1U;
    *c2_call_write_com3_buffer_C = 0U;
    _SFD_DATA_RANGE_CHECK((real_T)*c2_call_write_com3_buffer_C, 4U);
    ...
    *c2_call_write_3_bytes_to_pc_com3 = 1U;
    ...
    switch (chartInstance.c2_is_c2_minimalist) {
     case c2_IN_S01:
      CV_CHART_EVAL(0,0,1);
      ...
      chartInstance.c2_is_c2_minimalist = (uint8_T)c2_IN_S05;
      _SFD_CS_CALL(STATE_ACTIVE_TAG,1);
      chartInstance.c2_tp_S05 = 1U;
      *c2_call_write_com3_buffer_O = 0U;
      _SFD_DATA_RANGE_CHECK((real_T)*c2_call_write_com3_buffer_O, 3U);
     ...
     default:
      CV_CHART_EVAL(0,0,0);
      chartInstance.c2_is_c2_minimalist = (uint8_T)c2_IN_NO_ACTIVE_CHILD;
      _SFD_CS_CALL(STATE_INACTIVE_TAG,0);
      break;
    }
  }
...
const mxArray *sf_c2_minimalist_get_eml_resolved_functions_info(void)
{
...
void sf_c2_minimalist_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_minimalist_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c2_minimalist(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[12],T\"call_request_nav_packet\",},{M[1],M[14],T\"call_write_3_bytes_to_pc_com3\",},{M[1],M[18],T\"call_write_com3_buffer_C\",},{M[1],M[17],T\"call_write_com3_buffer_O\",},{M[1],M[19],T\"call_write_com3_buffer_third_byte\",},{M[8],M[0],T\"is_active_c2_minimalist\",},{M[9],M[0],T\"is_c2_minimalist\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_minimalist_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_minimalist(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_minimalist();
  initialize_c2_minimalist();
}

static void sf_opaque_enable_c2_minimalist(void *chartInstanceVar)
{
  enable_c2_minimalist();
}

static void sf_opaque_disable_c2_minimalist(void *chartInstanceVar)
{
  disable_c2_minimalist();
}

static void sf_opaque_gateway_c2_minimalist(void *chartInstanceVar)
{
  sf_c2_minimalist();
}

static mxArray* sf_opaque_get_sim_state_c2_minimalist(void *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c2_minimalist();
  return st;
}

static void sf_opaque_set_sim_state_c2_minimalist(void *chartInstanceVar, const
  mxArray *st)
{
  set_sim_state_c2_minimalist(sf_mex_dup(st));
}

static void sf_opaque_terminate_c2_minimalist(void *chartInstanceVar)
{
  ...
  finalize_c2_minimalist();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_minimalist(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_minimalist(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("minimalist","minimalist",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("minimalist","minimalist",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("minimalist","minimalist",
      2,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      sf_mark_chart_reusable_outputs(S,"minimalist","minimalist",2,5);
    }

    sf_set_rtw_dwork_info(S,"minimalist","minimalist",2);
...
static void mdlRTW_c2_minimalist(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "minimalist", "minimalist",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Stateflow");
  }
}

static void mdlStart_c2_minimalist(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 0;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c2_minimalist;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c2_minimalist;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c2_minimalist;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c2_minimalist;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c2_minimalist;
  chartInstance.chartInfo.getSimState = sf_opaque_get_sim_state_c2_minimalist;
  chartInstance.chartInfo.setSimState = sf_opaque_set_sim_state_c2_minimalist;
  chartInstance.chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_minimalist;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_minimalist;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_minimalist;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_minimalist;
...
void c2_minimalist_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_minimalist(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_minimalist(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_minimalist(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_minimalist_method_dispatcher.\n"
