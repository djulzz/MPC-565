...
#
# File    : minimalist10.mk   $Revision: 1.23.4.28 $
...
MODEL                   = minimalist10
MODULES                 = minimalist10_data.c mpc555_main.c 
MAKEFILE                = minimalist10.mk
...
NCSTATES                = 0
COMPUTER                = PCWIN
BUILDARGS               =  GENERATE_REPORT=0 PORTABLE_WORDSIZES=0 GENERATE_ASAP2=0 TMW_EXTMODE_TESTING=0 MPC555_OPTIMIZATION_SWITCH="speed" EXECUTION_PROFILING_ENABLED=0 EXECUTION_PROFILING_NUM_SAMPLES=500 RELATIVE_PATH_TO_ANCHOR=.. STANDALONE_SUPPRESS_EXE=1
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ONESTEPFCN              = 1
...
# Additional includes 
ADD_INCLUDES = \
	-IC:/DOCUME~1/AUTOPI~1/Desktop/-_DEMO~1/minimalist10_mpc555rt \
